...
public class Road8Script : MonoBehaviour
{
    ...
    {
        spawnTrain(ObjectPool.Instance.poolTran2.GetPooledObject(),new Vector3(3,0,transform.position.z+70));
        spawnTrain(ObjectPool.Instance.poolTran2.GetPooledObject(),new Vector3(-3,0,transform.position.z+120));
        spawnTrain(ObjectPool.Instance.poolTran2.GetPooledObject(),new Vector3(0,0,transform.position.z+170));
        spawnTrain(ObjectPool.Instance.poolTran4.GetPooledObject(),new Vector3(0,0,transform.position.z+190));
        spawnTrain(ObjectPool.Instance.poolTran4.GetPooledObject(),new Vector3(0,0,transform.position.z+262.2222f));
        spawnTrain(ObjectPool.Instance.poolTran4.GetPooledObject(),new Vector3(3,0,transform.position.z+334.4445f));
    }
