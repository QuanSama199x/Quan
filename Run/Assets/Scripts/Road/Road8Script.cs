...
public class Road8Script : MonoBehaviour
{
    ...
    {
        spawnTrain(ObjectPool.Instance.poolTrain[1].GetPooledObject(Resources.Load<GameObject>("Train/Train2")),new Vector3(3,0,transform.position.z+70));
        spawnTrain(ObjectPool.Instance.poolTrain[1].GetPooledObject(Resources.Load<GameObject>("Train/Train2")),new Vector3(-3,0,transform.position.z+120));
        spawnTrain(ObjectPool.Instance.poolTrain[1].GetPooledObject(Resources.Load<GameObject>("Train/Train2")),new Vector3(0,0,transform.position.z+170));
        spawnTrain(ObjectPool.Instance.poolTrain[3].GetPooledObject(Resources.Load<GameObject>("Train/Train4")),new Vector3(0,0,transform.position.z+190));
        spawnTrain(ObjectPool.Instance.poolTrain[3].GetPooledObject(Resources.Load<GameObject>("Train/Train4")),new Vector3(0,0,transform.position.z+262.2222f));
        spawnTrain(ObjectPool.Instance.poolTrain[3].GetPooledObject(Resources.Load<GameObject>("Train/Train4")),new Vector3(3,0,transform.position.z+334.4445f));
    }
    ...
    public void SpawnBlockinRoad()
    {
        ...
        SpawnBlocker(ObjectPool.Instance.PoolBlocker[0].GetPooledObject(Resources.Load<GameObject>("Blocker/Block" + 1)), new Vector3(0, 0.8f, transform.position.z));
        SpawnBlocker(ObjectPool.Instance.PoolBlocker[2].GetPooledObject(Resources.Load<GameObject>("Blocker/Block" + 3)), new Vector3(0, 0.8f, transform.position.z-73.4f));
    }
