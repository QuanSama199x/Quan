...
public class Road2Script : MonoBehaviour
{
    ...
    {
        spawnTrain(ObjectPool.Instance.poolTran3.GetPooledObject(),new Vector3(-3,0,transform.position.z-65));
        spawnTrain(ObjectPool.Instance.poolTran1.GetPooledObject(),new Vector3(0,0,transform.position.z-40));
        spawnTrain(ObjectPool.Instance.poolTran1.GetPooledObject(),new Vector3(-3,0,transform.position.z-20));
