...
public class Road9Script : MonoBehaviour
{
    ...
    {
        spawnTrain(ObjectPool.Instance.poolTran1.GetPooledObject(),new Vector3(-3,0,transform.position.z-65));
        spawnTrain(ObjectPool.Instance.poolTran7.GetPooledObject(),new Vector3(3,0,transform.position.z-65));
        spawnTrain(ObjectPool.Instance.poolTran7.GetPooledObject(),new Vector3(-3,0,transform.position.z-15));
        spawnTrain(ObjectPool.Instance.poolTran5.GetPooledObject(),new Vector3(3,0,transform.position.z-15));
        spawnTrain(ObjectPool.Instance.poolTran6.GetPooledObject(),new Vector3(0,0,transform.position.z-40));
        spawnTrain(ObjectPool.Instance.poolTran6.GetPooledObject(),new Vector3(0,0,transform.position.z+10));
    }
