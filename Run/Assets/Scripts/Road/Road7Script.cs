...
public class Road7Script : MonoBehaviour
{
    ...
    {
        spawnTrain(ObjectPool.Instance.poolTran3.GetPooledObject(),new Vector3(-3,0,transform.position.z-60));
        spawnTrain(ObjectPool.Instance.poolTran4.GetPooledObject(),new Vector3(0,0,transform.position.z+250));
        spawnTrain(ObjectPool.Instance.poolTran4.GetPooledObject(),new Vector3(0,0,transform.position.z+300));
        spawnTrain(ObjectPool.Instance.poolTran4.GetPooledObject(),new Vector3(0,0,transform.position.z+350));
        spawnTrain(ObjectPool.Instance.poolTran4.GetPooledObject(),new Vector3(0,0,transform.position.z+400));
    }
