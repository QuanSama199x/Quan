...
public class ObjectPool : MonoBehaviour
{
    ...
    /*public List<PoolElement> poolRoad;*/
    ...
    private void Start()
    {
        ...
        poolMagnet.Start(Resources.Load<GameObject>("Item/magnet")); poolShoes.Start(Resources.Load<GameObject>("Item/Shoes"));
        ...
        /*for (int i = 0; i < poolRoad.Count; i++)
        {
            poolRoad[i].Start(Resources.Load<GameObject>("Road/Road"+(i+1)));
        }*/
